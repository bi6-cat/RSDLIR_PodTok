        ...
        for result in data.get('results', []):
            if 'feedUrl' in result:
                rss_urls.append({
                    ...
                    'artworkUrl600': result.get('artworkUrl600', '')
                })
        return rss_urls
...
def build_csv_sheet(keywords, max_channels=25, max_episodes=5):
    ...
    with open(CSV_FILE, mode='w', newline='', encoding='utf-8') as file:
        ...
        # Ghi Header
        writer.writerow(['ID', 'Keyword', 'Podcast Name', 'Host Name', 'Channel Description', 'Episode Title', 'Audio URL', 'Image URL'])
        ...
        for keyword in keywords:
            ...
            for feed_info in discovered_feeds:
                ...
                host_name = feed_info['artistName']
                image_url = feed_info['artworkUrl600']
                ...
                try:
                    ...
                    if desc_elem is not None and desc_elem.text:
                        channel_desc = desc_elem.text.strip().replace('\n', ' ').replace('\r', '')
